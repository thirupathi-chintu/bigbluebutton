...
sed -i "s/proxy_pass .*/proxy_pass $PROTOCOL_HTTP:\/\/$IP:7443;/g" /etc/bigbluebutton/nginx/sip.nginx
...
change_yml_value /usr/local/bigbluebutton/bbb-webrtc-sfu/config/default.yml kurentoUrl "wss://$IP:8888/kurento"
